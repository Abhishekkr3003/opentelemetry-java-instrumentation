...
public class AerospikeClientAsyncWriteCommandInstrumentation implements TypeInstrumentation {
  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("com.aerospike.client.async.AsyncWrite");
  }
  ...
  public static class AsyncWriteCommandAdvice {
    ...
    public static AerospikeRequestContext onEnter(
      ...
      request = AerospikeRequest.create(Operation.Type.WRITE.name(), key);
